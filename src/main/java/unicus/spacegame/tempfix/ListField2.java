package unicus.spacegame.tempfix;
...
/**
 * The Class ListField.
 * This fix is based on an update belong to a future version of Litiengine.
 * This is a temporary patch imported so an important fix can be used right away.
 * TODO: remove once litiengine is updated to 0.4.19
 */
public class ListField2 extends GuiComponent {
     ...
     * @see #ListField2(double, double, double, double, Object[], int, boolean, Spritesheet, Spritesheet)
     */
    public ListField2(final double x, final double y, final double width, final double height, final Object[] content, final int shownRows) {
     ...
     */
    public ListField2(final double x, final double y, final double width, final double height, final Object[][] content, final int shownRows, final int shownColumns) {
